...
class AppRoutes {
  ...
  static const String trackBusScreen = '/trackBus'; // Fixed typo: was 'truckBusScreen' and had extra space
  ...
  static Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      passengerMapScreen: (context) => const PassengerMapScreen(), // Added const
      paymentScreen: (context) => const PaymentScreen(), // Added const
      profileScreen: (context) => const ProfileScreen(), // Added const
      //mapScreen: (context) => MapScreen(),
      emailVerificationScreen: (context) => const EmailVerificationScreen(), // Added const
      forgotPasswordScreen: (context) => const ForgotPasswordScreen(), // Added const
      adminScreen: (context) => const AdminDashboardScreen(), // Added const
      passengerHomeScreen: (context) => const BusTrackingScreen(), // Added const
      currentBusesScreen: (context) => const CurrentBusesScreen(), // Added const
      trackBusScreen: (context) { // Fixed variable name
      ...
      busManagementScreen: (context) => const BusManagementScreen(), // Added const
