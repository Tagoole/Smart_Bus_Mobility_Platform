...
class _PassengerMapScreenState extends State<PassengerMapScreen> {
  ...
  List<LatLng> myPolylinePoints = [
    const LatLng(0.3417239507478277, 32.55091817503237),
    const LatLng(0.32812375520940196, 32.55479778415132),
    // ...
  ];
  ...
  final List<LatLng> latlngForImages = <LatLng>[
    const LatLng(0.33064521748842635, 32.570565769870754),
    // ...
  ];
        ...
        onPressed: () async {
          ...
          controller.animateCamera(
            CameraUpdate.newCameraPosition(
              const CameraPosition(target: LatLng(0.34755, 32.56606), zoom: 14),
            ),
          );
          setState(() {});
        },
